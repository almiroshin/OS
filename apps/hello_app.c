...
static void draw_hello(void)
{
    ...
    framebuffer_draw_text(x + 14, y + 10, "HELLO", 0x00ffffff);

    framebuffer_draw_text_scaled(x + 44, y + 64, "HELLO APP", 0x00fff08a, 2);
    framebuffer_draw_text(x + 46, y + 108, "A SMALL BUILT IN TINYDOOMOS APP", 0x00d7e4ea);
    framebuffer_draw_text(x + 46, y + 132, "FRAMEBUFFER + KEYBOARD + TIMER", 0x00d7e4ea);
    framebuffer_draw_text(x + 46, y + 170, "ENTER OR ESC TO RETURN", 0x00a7f3ff);
}
